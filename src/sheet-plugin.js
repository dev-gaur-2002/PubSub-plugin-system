...
const callbackOnPull = (msg) => {
    ...
    const formattedResponse = [
        [
            messageData.name.stringValue,
            messageData.userName.stringValue,
            messageData.age.stringValue,
            messageData.phoneNumber.stringValue,
            messageData.salary.stringValue,
            messageData.savings.stringValue,
        ],
    ];
